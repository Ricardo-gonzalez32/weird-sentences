...
punctutation: [",", ":", " ", "!", ".", "?"],
    ...
    scifi : {
        "origin" : ["The #color# #animal# of the #nature# is called #name# and he is #mood#"],
        "color": ["orange","blue","white","black","grey","purple","indigo","turquoise"],
	    "animal": ["unicorn","raven","sparrow","scorpion","coyote","eagle","owl","lizard","zebra","duck","kitten"],
	    "nature": ["ocean","mountain","forest","cloud","river","tree","sky","sea","desert"],
        "name": ["james" , "chris" , "angel" ],
        "mood": ["sad" , "happy" , "mad" , "suprised"]
    },
